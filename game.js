...
let game = {
    ...
    update() {
        ...
        this.ball.collodeWorldBounds();
        this.platform.collodeWorldBounds();
        this.platform.move();
        this.ball.move();
    },
    addScore() {
    ...
    run() {
        if (this.running) {
            ...
            this.update();
            this.render();
            //рекурсия для отрисовки актуальной информации (новыми координатами)
            this.run();
        });}
    },
    render() {
...
game.ball = {
    ...
    collodeWorldBounds(){
        ...
        let ballTop = y;
        let ballDown = ballTop + this.height;
...
game.platform = {
    ...
    collodeWorldBounds() {
        ...
        let platLeft = x;
        let platRight = platLeft + this.width;

        let worldLeft = 0;
        let worldRight = game.width;

        if(platLeft < worldLeft || platRight > worldRight) {
            this.dx = 0;
        }
    }
};
